...
try:
    # tf_keras is the standalone Keras 2 package required by some TF builds.
    from tf_keras import Model, layers  # type: ignore
except Exception:
    # Fall back to bundled keras (works on tensorflow-macos < 2.16).
